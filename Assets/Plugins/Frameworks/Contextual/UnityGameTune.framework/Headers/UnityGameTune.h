...
#import "UGTEventListener.h"
#import "UGTUserAttributesProvider.h"
 ...
 *
 *  @param projectId Unity Project ID (UPID), generated for a project on operate dashboard
 *  @param options Pass options which include privacy consent and user id.
 */
+ (void)initialize:(NSString *)projectId
 ...
 *  @param projectId Unity Project ID (UPID), generated for a project on operate dashboard.
 *  @param options Pass options which include privacy consent and user id.
 *  @param eventListener Object that listens to GameTune events
 */
+ (void)initialize:(NSString *)projectId
    withOptions:(UGTInitializeOptions *)options
    withEventListener:(id<UGTEventListener>)eventListener;
 ...
 *  @param options Pass options which include privacy consent and user id.
 *  @param eventListener Object that listens to GameTune events
 *  @param userAttributesProvider Object that provides user attributes when asked by the SDK
 */
+ (void)initialize:(NSString *)projectId
    withOptions:(UGTInitializeOptions *)options
    withEventListener:(id<UGTEventListener>)eventListener
    withUserAttributesProvider:(id<UGTUserAttributesProvider>)userAttributesProvider;
...
+ (void)setPrivacyConsent:(BOOL)privacyConsent;
